...
contract SquadManager is Ownable {
    ...
    // Verification threshold - SET TO 1 FOR DEMO
    uint256 public constant VERIFICATION_THRESHOLD = 1; // 1 verification for demo
    ...
    // Submit function with photo (ipfsHash), quote, and challengeDay
    ...
    // Verify submission with threshold (1 for demo)
        ...
        onlySquadMember(squadName) 
    {
        ...
        // Check if reached threshold (1 for demo)
