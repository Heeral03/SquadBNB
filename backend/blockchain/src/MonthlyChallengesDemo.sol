...
contract MonthlyChallengeDemo is Ownable, ReentrancyGuard {
    ...
    // ============ DEMO CONSTANTS - 1 MINUTE TOTAL ============
    
    uint256 public constant VOTES_REQUIRED = 2;
    uint256 public constant CHALLENGE_DURATION = 60 seconds;      // 1 minute
    uint256 public constant REVIEW_SUBMISSION_WINDOW = 15 seconds; // Last 15 seconds
    uint256 public constant VOTING_DURATION = 20 seconds;         // 20 seconds voting
    ...
    function _executeProposal(uint256 proposalId) internal {
        ...
        if (proposal.sponsorAmount > 0 && rewardPool >= proposal.sponsorAmount / 10) {
    ...
    function submitReview(uint256 challengeId, string calldata ipfsHash) external {
        ...
        // Submission window: last 15 seconds of the challenge
    ...
    function voteForReview(uint256 challengeId, uint256 reviewId) external {
        ...
        // Voting period: 20 seconds after challenge ends
