import{du as x,dV as te,cM as c,cO as ne,cy as g,cz as j,cC as m,cD as b,cE as d,cB as l,d7 as k,cX as z,d8 as u,cA as se,cT as f,cG as D,d5 as L,dR as le,dA as V,cQ as U,dg as R,c$ as F,cJ as ce,cN as A,dw as T,dO as q,d6 as de,cI as ie,dW as ue,dX as he}from"./index-BDcKlTkx.js";import{P as _}from"./index-CISDMX4b.js";import{S as pe}from"./SwapController-BynQ8LwT.js";const oe={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await te.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&ne.disconnect(),x.close()}},me=g`
  :host {
    display: block;
